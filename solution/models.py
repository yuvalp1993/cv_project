...
def get_xception_based_model() -> nn.Module:
    ...
    num_features = 2048 # This matches the output dimension of Xception's last convulational layer

    #Creating the new MLP head and replacing with it the 'fc' layer
